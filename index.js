...
/* A function is able to look for a variable within itself and outside as well, as long as it isn't in a different function. This function is able to access it because the function is nested within the function containing the variable. */
...
let reduction = (accumulator, item) => {
  return accumulator + item;
}
function USApop(arr){
  let sum = [];
  arr.forEach(item => sum.push(item['population']));
  return Object.values(sum).reduce((a,b) => a+b);
}
